...
export function PriceRangeFilters({
  ...
  }, [debouncedMinPrice, debouncedMaxPrice, MAX_PRICE, tempMaxPrice, MIN_PRICE, tempMinPrice, setSelectedFilters, selectedFilters])
    ...
    <section>
      ...
      <div className="pt-10">
        <Slider
          ...
          onChange={(value) => handleSliderChange(Array.isArray(value) ? value : [value])}
          minValue={MIN_PRICE}
          maxValue={MAX_PRICE}
          step={1}
        />
